...
//------------------------------------------------------------------------------------------------------------
  private:
	...
	static const uint16_t GPIO_Z	// High impedance (default)
	static const uint16_t GPIO_I 	// GPIO1-Reserved, GPIO2-STC/RDS int, or GPIO3-Mono/Sterio Indicator
	static const uint16_t GPIO_Low	// Low output (GND level)
	static const uint16_t GPIO_High	// High output (VIO level)
};
